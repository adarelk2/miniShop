<?php
//The function receives an array of "param"=>["type",$value] and table name and inserts the data
//for example: "DocNumber"=>["i",'1111']
function SQL_InsertBind($MySQLInsertArray, $TBName, $mysqli = null)
{
    ...
    // echo "<pre>";
    // print_r($MySQLInsertArray);
    // print_r("INSERT INTO " . $TBName . " (" . $ColumnList . ") VALUES (" . $MySQLQs . ")");
    // echo "<br></pre>";
...
//The function receives an array of "param"=>["type",$value], a table number and a comax_ID and updates the data
//for example: "DocNumber"=>["i",'1111']
...
//The function receives an array of "param"=>["type",$value], a table number and a comax_ID and selects the data
//for example: "DocNumber"=>["i",'1111']
